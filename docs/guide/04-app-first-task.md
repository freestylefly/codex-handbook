...
::: tip 最后核对
官方资料最后核对日期：2026-05-11。本章以开发一个简单网页为例，演示从创建工作目录到任务迭代的完整操作流程。
:::

本章以"用 Codex App 开发一个关于 AI 发展历史的简单网页"为例，走完一次完整的任务闭环，帮助你快速上手 Codex App 的基本用法。
...
打开 Codex App 后，你需要选择用"对话"还是"项目"来开始任务。
