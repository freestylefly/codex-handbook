...
export default navbar([
  ...
  },
  {
    ...
    icon: "book",
    children: [
      { text: "01 Codex App 下载与安装", icon: "mobile", link: "/guide/01-app-installation.md" },
      { text: "02 订阅 ChatGPT Plus", icon: "star", link: "/guide/02-subscribe-plus.md" },
      { text: "03 了解 Codex 基本组成", icon: "layout", link: "/guide/03-app-overview.md" },
      { text: "04 用 Codex 完成第一个任务", icon: "code", link: "/guide/04-app-first-task.md" },
      { text: "05 任务顺序执行与并行", icon: "list", link: "/guide/05-task-execution.md" },
      { text: "06 权限管理", icon: "safe", link: "/guide/06-permissions.md" },
      { text: "07 技能与插件", icon: "plugin", link: "/guide/07-skills-plugins.md" },
      { text: "08 自动化", icon: "time", link: "/guide/08-automation.md" },
      { text: "09 桌面宠物", icon: "cat", link: "/guide/09-desktop-pet.md" },
      { text: "10 CLI 安装与登录", icon: "download", link: "/guide/10-cli-installation.md" },
      { text: "11 第一次让 Codex 改代码", icon: "edit", link: "/guide/11-cli-first-run.md" },
      { text: "12 在 VS Code 中使用 Codex", icon: "code", link: "/guide/12-ide-vscode.md" },
      { text: "13 AGENTS.md", icon: "file", link: "/guide/14-agents-md.md" },
      { text: "14 沙盒与审批", icon: "lock", link: "/guide/15-sandbox-approvals.md" },
      { text: "15 Codex Cloud：使用云端模式", icon: "cloud", link: "/guide/16-cloud-ide-app.md" },
      { text: "16 排障手册", icon: "debug", link: "/guide/18-troubleshooting.md" },
    ],
  },
  {
    text: "实战案例",
