...
![image-20260510150638133](https://zzy-1326340203.cos.ap-beijing.myqcloud.com//image-20260510150638133.png?imageSlim)

有些环境下，第一次点击后会跳转到浏览器插件安装页，或者提示你连接现有浏览器。

![image-20260510150753382](https://zzy-1326340203.cos.ap-beijing.myqcloud.com//image-20260510150753382.png?imageSlim)
...
```text
请使用浏览器能力打开 Bilibili，搜索“IG 知识库 教程”，找一个适合新手入门的视频，并把标题和链接返回给我。
```
...
![image-20260510150851878](https://zzy-1326340203.cos.ap-beijing.myqcloud.com//image-20260510150851878.png?imageSlim)
